...
const HomeScreen = () => {
    return (
        <Container>
                <Title text="Extablish a Daily Habit" textColor="lavenderblush" />
                <Subtitle text="Get a clear view of the day ahead" textColor="black" />
                <View style={styles.homeButtonContainer}>
                    <CustomButtonNavigate title='ToDo List' task="ExploreScreen" navigate='true' textColor='white' backgroundColor='#212729' />
                </View>
        </Container>
    );
};
